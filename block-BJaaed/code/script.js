    ...
    body.style.backgroundColor = `rgb(253,245,232)`
    // h1
    var h1 = document.createElement(`h1`);
    // appending h1 under body
    body.append(h1);
    // styling h1
    h1.innerText = `Bookly`;
    h1.style.backgroundColor = `rgb(55,126,128)`;
    h1.style.color = `rgb(252,239,65)`;
